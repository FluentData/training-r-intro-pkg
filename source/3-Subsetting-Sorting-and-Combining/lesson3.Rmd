...
```{r ex-rhsJ7-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Load `chicago_air` Data Frame'}
data(chicago_air)
...
```{r ex-gjTC8-2, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install `dplyr` Package'}
...
```{r ex-uadZf-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'View the First Few Rows of `chicago_air`'}
data(chicago_air)
head(chicago_air)
...
```{r ex-wiPii-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Specify Number of Lines with `head()`'}
data(chicago_air)
...
```{r ex-v3LKX-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'View the Last Few Rows of `chicago_air`'}
data(chicago_air)
tail(chicago_air)
...
```{r ex-8BmFP-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Use `View()` to Inspect `chicago_air`'}
data(chicago_air)
View(chicago_air)
...
```{r ex-XjN5w-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Learn More About `chicago_air`'}
?chicago_air
...
```{r ex-oyetx-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Explore Data Frame Indexing with `my_data`'}
...
```{r ex-Ak71D-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Select a Specific Value Using Indexing'}
my_data[2, 1]
...
```{r ex-YQHGB-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access Another Specific Value Using Indexing'}
my_data[3, 2]
...
```{r ex-H2uPA-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Vector Indexing Example'}
x <- c(1, 3, 2, 7, 25.3, 6)
x
...
```{r ex-vXrcz-5, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access a Vector Element by Index'}
x[5]
...
```{r ex-p0ewl-6, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Subset `chicago_air` Data Frame Using Indexing'}
data(chicago_air)
chicago_air[1, ]
...
```{r ex-xohVU-7, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access Multiple Rows with a Vector of Row Numbers'}
data(chicago_air)
chicago_air[c(1, 2, 5), ]
...
```{r ex-7HykZ-8, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access a Single Column'}
data(chicago_air)
head(chicago_air[, 1])
...
```{r ex-cLvsy-9, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access Multiple Columns'}
data(chicago_air)
...
```{r ex-rHOT9-10, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access a Column by Name'}
data(chicago_air)
...
```{r ex-St8Kw-11, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Subset to Specific Columns by Name'}
data(chicago_air)
...
```{r ex-i3bSe-12, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Specify Both Rows and Columns for Subsetting'}
...
```{r ex-Sgk8C-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Access a Column with `$`'}
data(chicago_air)
...
```{r ex-O6c3K-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Logical Expressions Example 1'}
1 + 1 == 2

```

```{r ex-uYxnP-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Logical Expressions Example 2'}
10 > 20
...
```{r ex-Rn0uk-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Vector Logical Expression'}
c(25, 80, 55) > 60
...
```{r ex-OU4Qy-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Create a Logical Vector for Subsetting'}
my_data <- data.frame(colors = c("red", "green", "yellow"),
                      fruit = c("apple", "grape", "banana"))
...
```{r ex-waHk8-5, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Subset Using a Logical Vector'}
...
```{r ex-8hsM1-6, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Create a Logical Vector with a Logical Expression'}
...
```{r ex-lRQF3-7, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Subset Data Frame Using Logical Vector'}
my_data[yellow, ]
...
```{r ex-amEqK-8, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Subset `chicago_air` for Hot Days'}
data(chicago_air)
...
```{r ex-pw0yG-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Load `dplyr` and Explore `filter()`'}
...
```{r ex-SXJI7-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Filter `chicago_air` for High Ozone Levels'}
data(chicago_air)
...
```{r ex-1Ywmx-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Filter for High Ozone Levels in June'}
data(chicago_air)
...
```{r ex-VB8Iw-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Alternative `filter()` Syntax Using `&`'}
data(chicago_air)
high_ozone_june <- filter(chicago_air, ozone > 0.060 & month == 6)
...
```{r ex-Y4Bfa-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Sort `chicago_air` by `ozone`'}
...
```{r ex-LPAi6-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Sort `chicago_air` in Descending Order by `ozone`'}
data(chicago_air)
...
```{r ex-5DEVZ-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Sort `chicago_air` by Multiple Columns'}
data(chicago_air)
...
```{r ex-LSplD-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Count Rows in `chicago_air`'}
...
```{r ex-HAt4O-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Split `chicago_air` into Warm and Cool Subsets'}
data(chicago_air)
...
```{r ex-kfoYa-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Verify Row Counts Before Combining'}
...
```{r ex-sBZyM-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Recombine Data Frames and Verify Row Count'}
data(chicago_air)
