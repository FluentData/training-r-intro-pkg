...
```{r ex-JyQbU-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Mean'}
x <- c(4, 8, 1, 14, 34)
mean(x)
...
```{r ex-hlL6g-2, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Natural Logarithm'}
log(27)  #Natural logarithm

```

```{r ex-ZYFyu-3, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Base 10 Logarithm'}
log10(100) #base 10 logarithm

```

```{r ex-UU8YY-4, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Square Root'}
sqrt(225) # Square root

```

```{r ex-jqEs0-5, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Absolute Value'}
...
```{r ex-vcIgQ-7, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Round to Zero Digits'}
round(12.3456)

```

```{r ex-OcULs-8, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Round to Three Digits'}
round(12.3456, digits=3)

```

```{r ex-UGmXo-9, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Round to One Digit'}
...
```{r ex-1Ep4Q-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Sum of Values'}
sum(c(2.3, 7.5, 9, -10))
...
```{r ex-r9tUb-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Minimum Value'}
min(c(6, 9, 3, 11, -2))
...
```{r ex-CGGfO-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Maximum Value'}
max(c(6, 9, 3, 11, -2))
...
```{r ex-NVkis-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Create Sequence with `seq()`'}
...
```{r ex-aEpVG-2, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Create Sequence with Colon Operator'}
1:5
...
```{r ex-aUqJd-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Concatenate Strings'}
x <- "Hello"
y <- "world!"
paste(x, y, sep = " ")
...
```{r ex-hWAMP-2, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Concatenate Strings with Numbers'}
x <- "You're number "
y <- 1
z <- "!"
paste(x, y, z, sep = "")
...
```{r ex-P1oja-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Extract Site Number'}
...
```{r ex-MCmvl-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Mean in Two Steps'}
#Two steps
...
```{r ex-8bxAo-2, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Calculate Mean in One Step'}
#One step
...
```{r ex-wT6hn-1, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Inspect `airquality` Data'}
data("airquality")
head(airquality)
...
```{r ex-jjagp-2, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Mean with NA Values'}
...
```{r ex-2zWwa-3, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Mean with NA Removal'}
...
```{r ex-wEzJ6-2, message = FALSE}
library(EnvStats)

```

```{r ex-48q9u-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Use `serialCorrelationTest` from EnvStats'}
x <- c(1.3, 3.5, 2.6, 3.4, 6.4)
serialCorrelationTest(x)
...
```{r ex-lAQFp-3, exercise = TRUE, exercise.eval = TRUE, exercise.lines = 5, exercise.cap = 'Read and Inspect Excel Data'}
library(readxl)
