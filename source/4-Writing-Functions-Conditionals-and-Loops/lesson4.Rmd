...
```{r ex-LAzMi-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Load Data from This Package'}
...
```{r ex-Vp36z-1, eval = FALSE, exercise = TRUE, exercise.cap = 'Creating Your Own Function'}
...
```{r ex-dDpnb-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Simple Function to Print Hello'}
...
```{r ex-iqByZ-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Testing the print_hello Function'}
print_hello()
...
```{r ex-etpp4-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Function with an Argument'}
...
```{r ex-akhdH-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Testing the Modified print_hello Function'}
...
```{r ex-c3xyo-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Function with Two Arguments'}
...
```{r ex-iHYx9-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Testing check_standard Function'}
...
```{r ex-U3vNt-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Function with Default Value'}
...
```{r ex-Y6r7K-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Testing check_standard with Default Value'}
...
```{r ex-jlURy-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Testing Positional Arguments'}
check_standard(60, 70)

```

```{r ex-mAlsy-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Testing Positional Arguments in Reverse Order'}
...
```{r ex-7Y8OQ-1, eval = FALSE, exercise = TRUE, exercise.cap = 'if Function Outline'}
...
```{r ex-kpwqv-2, eval = FALSE, exercise = TRUE, exercise.cap = 'if-else Function Outline'}
if(<logical expression>) {
...
```{r ex-hgfXq-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'if Function Example'}
ozone <- 0.075
...
```{r ex-kZOyI-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Another if Function Example'}
ozone <- 0.06
...
```{r ex-KE8Ob-5, eval = FALSE, exercise = TRUE, exercise.cap = 'ifelse Function Outline'}
ifelse(<test>, <yes>, <no>)

```

```{r ex-Z52Rv-6, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'ifelse Function Example'}
ozone_value <- 0.06
...
```{r ex-DpMR0-1, eval = FALSE, exercise = TRUE, exercise.cap = 'For Loop Outline'}
for(i in sequence){
...
```{r ex-cvpGz-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'For Loop Example'}
for(i in c(1, 2, 3)) {
...
```{r ex-yYm6W-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'For Loop with Data Frame'}
...
```{r ex-7kJUi-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Finding Maximum Values with For Loop'}
max_values <- c()
...
```{r ex-zVkWt-1, eval = FALSE, exercise = TRUE, exercise.cap = 'apply Function Example'}
