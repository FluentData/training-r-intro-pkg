...
```{r ex-ZqRtB-1, exercise = TRUE, exercise.cap = 'Extract example data'}
...
```{r ex-8EO70-2, exercise = TRUE, exercise.cap = 'Find minimum value'}
min(data, na.rm=TRUE)

```

```{r ex-A6prs-3, exercise = TRUE, exercise.cap = 'Find maximum value'}
max(data, na.rm=TRUE)

```

```{r ex-yr4JW-4, exercise = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-aTfou-5, exercise = TRUE, exercise.cap = 'Summary statistics'}
summary(data)
...
```{r ex-k0n2i-6, exercise = TRUE, exercise.cap = 'Calculate IQR'}
IQR(data, na.rm=TRUE)
...
```{r ex-8sric-7, exercise = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(data)
...
```{r ex-z0nhT-1, exercise = TRUE, exercise.cap = 'Calculate mean'}
mean(data, na.rm=TRUE)

```

```{r ex-SKY0Q-2, exercise = TRUE, exercise.cap = 'Calculate median'}
...
```{r ex-fo54i-3, exercise = TRUE, exercise.cap = 'Calculate variance'}
var(data, na.rm=TRUE)

```

```{r ex-mnQcM-4, exercise = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(data, na.rm=TRUE)
...
```{r ex-QIlwk-1, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Visualize dataset'}
...
```{r ex-bNIUR-2, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Compare two groups'}
...
```{r ex-i5Rj0-3, exercise = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-n8nPA-4, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-5a6F0-5, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-LeaNy-6, exercise = TRUE, exercise.cap = 'Student's t-test between two groups'}
...
```{r ex-yuR5R-1, exercise = TRUE, exercise.cap = 'Correlation matrix of select variables'}
...
```{r ex-msgSM-2, exercise = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-VUJTs-3, exercise = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-lvyKT-4, exercise = TRUE, exercise.cap = 'Pairwise plots of select variables'}
