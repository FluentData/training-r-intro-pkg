...
```{r ex-A3y1d-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading Data'}
data(chicago_air)
...
```{r ex-FPccd-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Basic Plot'}
...
```{r ex-uhmt6-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Scatter Plot'}
...
```{r ex-3IlBg-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Converting Date Column'}
...
```{r ex-zDfMy-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Graph'}
...
```{r ex-V752S-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Plot'}
...
```{r ex-BUPIc-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Default Histogram'}
...
```{r ex-u1S2k-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Histogram'}
hist(chicago_air$ozone,
     breaks = 20,
...
```{r ex-okLwS-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Box Plot'}
...
```{r ex-wFoJU-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Box Plot by Month'}
...
```{r ex-Wi6W9-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading ggplot2 Package'}
library(ggplot2)
...
```{r ex-iLeG0-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Base ggplot'}
...
```{r ex-Gxopn-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Scatter Plot'}
...
```{r ex-MSNnS-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized ggplot Scatter Plot'}
ggplot(chicago_air, aes(x = temp, y = ozone)) +
...
```{r ex-X10CR-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Color Coded Scatter Plot'}
...
```{r ex-CnQ2o-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Plot Over Time'}
...
```{r ex-xOPPy-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Histogram'}
...
```{r ex-rEI41-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple ggplot Box Plot'}
...
```{r ex-Cvkie-9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Grouped Box Plot'}
...
```{r ex-jxiWS-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Faceted Histogram'}
ggplot(chicago_air, aes(ozone)) +
  geom_histogram() +
  facet_wrap("month")
...
```{r ex-kSfPO-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Linear Model Fitted Line', message = FALSE, warning = FALSE}
...
```{r ex-vlqVl-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Nonlinear Curve Fitting', message = FALSE, warning = FALSE}
ggplot(chicago_air, aes(temp, ozone) ) +
  geom_point() +
