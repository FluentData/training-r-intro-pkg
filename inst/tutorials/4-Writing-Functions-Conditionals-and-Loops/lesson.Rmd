...
```{r ex-nrhfD-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load Data from This Package'}
...
```{r ex-leVmm-1, eval = FALSE, exercise = TRUE, exercise.cap = 'Creating Your Own Function'}
...
```{r ex-HqNOS-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Function to Print Hello'}
...
```{r ex-fwQ5L-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing the print_hello Function'}
print_hello()
...
```{r ex-2P8Tn-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with an Argument'}
...
```{r ex-LRgr3-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing the Modified print_hello Function'}
...
```{r ex-0qVRQ-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with Two Arguments'}
...
```{r ex-Qop4d-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing standard_violated Function'}
...
```{r ex-MZLuD-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with Default Value'}
...
```{r ex-3zbVT-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing standard_violated with Default Value'}
...
```{r ex-GWBtx-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing Positional Arguments'}
standard_violated(60, 70)

```

```{r ex-8GIop-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing Positional Arguments in Reverse Order'}
...
```{r ex-QUyL3-1, eval = FALSE, exercise = TRUE, exercise.cap = 'if Function Outline'}
...
```{r ex-UdUgn-2, eval = FALSE, exercise = TRUE, exercise.cap = 'if-else Function Outline'}
if(<logical expression>) {
...
```{r ex-48zih-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'if Function Example'}
ozone <- 0.075
...
```{r ex-gDSuK-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Another if Function Example'}
ozone <- 0.06
...
```{r ex-3aWMJ-5, eval = FALSE, exercise = TRUE, exercise.cap = 'ifelse Function Outline'}
ifelse(<test>, <yes>, <no>)

```

```{r ex-2YM6L-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ifelse Function Example'}
ozone_value <- 0.06
...
```{r ex-ofECG-1, eval = FALSE, exercise = TRUE, exercise.cap = 'For Loop Outline'}
for(i in sequence){
...
```{r ex-dU92z-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'For Loop Example'}
for(i in c(1, 2, 3)) {
...
```{r ex-0a2Hb-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'For Loop with Data Frame'}
...
```{r ex-koVZJ-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Finding Maximum Values with For Loop'}
max_values <- c()
...
```{r ex-TQVh0-1, eval = FALSE, exercise = TRUE, exercise.cap = 'apply Function Example'}
...
```{r ex-bGiYj-2, eval = FALSE, exercise = TRUE, exercise.cap = 'apply Function Example with MARGIN = 1'}
