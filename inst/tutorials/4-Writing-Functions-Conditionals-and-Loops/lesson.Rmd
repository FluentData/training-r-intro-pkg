...
```{r ex-3o9QU-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load Data from This Package'}
...
```{r ex-TKrxr-1, eval = FALSE, exercise = TRUE, exercise.cap = 'Creating Your Own Function'}
...
```{r ex-DhgNN-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Function to Print Hello'}
...
```{r ex-HNelP-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing the print_hello Function'}
print_hello()
...
```{r ex-acAPB-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with an Argument'}
...
```{r ex-nYAoF-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing the Modified print_hello Function'}
...
```{r ex-GNlUH-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with Two Arguments'}
...
```{r ex-B07Ji-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing check_standard Function'}
...
```{r ex-8R3Fu-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with Default Value'}
...
```{r ex-AGj1F-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing check_standard with Default Value'}
...
```{r ex-gYfUN-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing Positional Arguments'}
check_standard(60, 70)

```

```{r ex-M6ihF-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing Positional Arguments in Reverse Order'}
...
```{r ex-v31Mv-1, eval = FALSE, exercise = TRUE, exercise.cap = 'if Function Outline'}
...
```{r ex-w0guS-2, eval = FALSE, exercise = TRUE, exercise.cap = 'if-else Function Outline'}
if(<logical expression>) {
...
```{r ex-gIza2-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'if Function Example'}
ozone <- 0.075
...
```{r ex-0LSuT-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Another if Function Example'}
ozone <- 0.06
...
```{r ex-ManhC-5, eval = FALSE, exercise = TRUE, exercise.cap = 'ifelse Function Outline'}
ifelse(<test>, <yes>, <no>)

```

```{r ex-fE02M-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ifelse Function Example'}
ozone_value <- 0.06
...
```{r ex-6BnHz-1, eval = FALSE, exercise = TRUE, exercise.cap = 'For Loop Outline'}
for(i in sequence){
...
```{r ex-dtU6E-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'For Loop Example'}
for(i in c(1, 2, 3)) {
...
```{r ex-EnblP-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'For Loop with Data Frame'}
...
```{r ex-3LdFb-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Finding Maximum Values with For Loop'}
max_values <- c()
...
```{r ex-zRT3X-1, eval = FALSE, exercise = TRUE, exercise.cap = 'apply Function Example'}
