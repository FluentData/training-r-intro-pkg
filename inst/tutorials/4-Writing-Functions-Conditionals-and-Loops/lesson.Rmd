...
```{r ex-4CuQl-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Load Data from This Package'}
...
```{r ex-t7yHC-1, eval = FALSE, exercise = FALSE, exercise.cap = 'Creating Your Own Function'}
...
```{r ex-2naKj-2, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Simple Function to Print Hello'}
...
```{r ex-UbiH2-3, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Testing the print_hello Function'}
print_hello()
...
```{r ex-MG243-1, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Function with an Argument'}
...
```{r ex-DSUaV-2, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Testing the Modified print_hello Function'}
...
```{r ex-sr9oK-1, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Function with Two Arguments'}
...
```{r ex-RQuh9-2, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Testing standard_violated Function'}
...
```{r ex-VdN4n-3, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Function with Default Value'}
...
```{r ex-h5BDv-4, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Testing standard_violated with Default Value'}
...
```{r ex-GLmqd-1, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Testing Positional Arguments'}
standard_violated(60, 70)

```

```{r ex-2kRT1-2, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Testing Positional Arguments in Reverse Order'}
...
```{r ex-hFYnI-1, eval = FALSE, exercise = FALSE, exercise.cap = 'if Function Outline'}
...
```{r ex-PQekF-2, eval = FALSE, exercise = FALSE, exercise.cap = 'if-else Function Outline'}
if(<logical expression>) {
...
```{r ex-MLtEn-3, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'if Function Example'}
ozone <- 0.075
...
```{r ex-dHD9U-4, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Another if Function Example'}
ozone <- 0.06
...
```{r ex-fRZPE-5, eval = FALSE, exercise = FALSE, exercise.cap = 'ifelse Function Outline'}
ifelse(<test>, <yes>, <no>)
...
```{r ex-eQ3xL-6, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'ifelse Function Example'}
ozone_value <- 0.06
...
```{r ex-ALKD7-1, eval = FALSE, exercise = FALSE, exercise.cap = 'For Loop Outline'}
for(i in sequence){
...
```{r ex-KfAIh-2, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'For Loop Example'}
for(i in c(1, 2, 3)) {
...
```{r ex-pR9S4-3, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'For Loop with Data Frame'}
...
```{r ex-JKWHs-4, exercise = FALSE, exercise.eval = FALSE, eval = TRUE, exercise.cap = 'Finding Maximum Values with For Loop'}
max_values <- c()
...
```{r ex-hoyq9-1, eval = TRUE, exercise = FALSE, exercise.cap = 'apply Function Example'}
...
```{r ex-Z3b46-2, eval = TRUE, exercise = FALSE, exercise.cap = 'apply Function Example with MARGIN = 1'}
