...
```{r ex-24n3M-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load Data from This Package'}
...
```{r ex-8LfCw-1, eval = FALSE, exercise = TRUE, exercise.cap = 'Creating Your Own Function'}
...
```{r ex-fJfsU-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Function to Print Hello'}
...
```{r ex-Vn2hP-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing the print_hello Function'}
print_hello()
...
```{r ex-K2PH7-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with an Argument'}
...
```{r ex-dbS3B-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing the Modified print_hello Function'}
...
```{r ex-O1ybZ-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with Two Arguments'}
...
```{r ex-UDcsY-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing standard_violated Function'}
...
```{r ex-1jUrF-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Function with Default Value'}
...
```{r ex-5LeDW-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing standard_violated with Default Value'}
...
```{r ex-IJniY-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing Positional Arguments'}
standard_violated(60, 70)

```

```{r ex-kb4G6-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Testing Positional Arguments in Reverse Order'}
...
```{r ex-4luYi-1, eval = FALSE, exercise = TRUE, exercise.cap = 'if Function Outline'}
...
```{r ex-5JB6E-2, eval = FALSE, exercise = TRUE, exercise.cap = 'if-else Function Outline'}
if(<logical expression>) {
...
```{r ex-eb5H2-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'if Function Example'}
ozone <- 0.075
...
```{r ex-cf4DF-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Another if Function Example'}
ozone <- 0.06
...
```{r ex-eZIEd-5, eval = FALSE, exercise = TRUE, exercise.cap = 'ifelse Function Outline'}
ifelse(<test>, <yes>, <no>)

```

```{r ex-9JM2l-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ifelse Function Example'}
ozone_value <- 0.06
...
```{r ex-Smpxz-1, eval = FALSE, exercise = TRUE, exercise.cap = 'For Loop Outline'}
for(i in sequence){
...
```{r ex-fBA2v-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'For Loop Example'}
for(i in c(1, 2, 3)) {
...
```{r ex-nl8GA-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'For Loop with Data Frame'}
...
```{r ex-XonUy-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Finding Maximum Values with For Loop'}
max_values <- c()
...
```{r ex-RldII-1, eval = FALSE, exercise = TRUE, exercise.cap = 'apply Function Example'}
...
```{r ex-fyIqy-2, eval = FALSE, exercise = TRUE, exercise.cap = 'apply Function Example with MARGIN = 1'}
