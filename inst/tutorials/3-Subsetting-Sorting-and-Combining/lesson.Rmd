...
```{r ex-Ff5Sd-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load `chicago_air` Data Frame'}
data(chicago_air)
...
```{r ex-61y8i-2, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install `dplyr` Package'}
...
```{r ex-XBPSe-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'View the First Few Rows of `chicago_air`'}
data(chicago_air)
head(chicago_air)
...
```{r ex-W8xk7-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Specify Number of Lines with `head()`'}
data(chicago_air)
...
```{r ex-k9SN6-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'View the Last Few Rows of `chicago_air`'}
data(chicago_air)
tail(chicago_air)
...
```{r ex-4Q5uw-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Use `View()` to Inspect `chicago_air`'}
data(chicago_air)
View(chicago_air)
...
```{r ex-fcXTz-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Learn More About `chicago_air`'}
?chicago_air
...
```{r ex-wbzvC-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Explore Data Frame Indexing with `my_data`'}
...
```{r ex-dIfsD-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Select a Specific Value Using Indexing'}
my_data[2, 1]
...
```{r ex-dQYP7-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access Another Specific Value Using Indexing'}
my_data[3, 2]
...
```{r ex-crQeB-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Vector Indexing Example'}
x <- c(1, 3, 2, 7, 25.3, 6)
x
...
```{r ex-0RkJ8-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Vector Element by Index'}
x[5]
...
```{r ex-pJuzG-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset `chicago_air` Data Frame Using Indexing'}
data(chicago_air)
chicago_air[1, ]
...
```{r ex-rOwjG-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access Multiple Rows with a Vector of Row Numbers'}
data(chicago_air)
chicago_air[c(1, 2, 5), ]
...
```{r ex-DidXA-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Single Column'}
data(chicago_air)
head(chicago_air[, 1])
...
```{r ex-lUdte-9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access Multiple Columns'}
data(chicago_air)
...
```{r ex-vaAO3-10, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Column by Name'}
data(chicago_air)
...
```{r ex-3yZVc-11, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset to Specific Columns by Name'}
data(chicago_air)
...
```{r ex-YRGcl-12, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Specify Both Rows and Columns for Subsetting'}
...
```{r ex-9PZ88-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Column with `$`'}
data(chicago_air)
...
```{r ex-ZjgTb-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Logical Expressions Example 1'}
1 + 1 == 2

```

```{r ex-rlN7A-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Logical Expressions Example 2'}
10 > 20
...
```{r ex-wZ7Fl-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Vector Logical Expression'}
c(25, 80, 55) > 60
...
```{r ex-9sTMH-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Create a Logical Vector for Subsetting'}
my_data <- data.frame(colors = c("red", "green", "yellow"),
                      fruit = c("apple", "grape", "banana"))
...
```{r ex-Ld3tB-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset Using a Logical Vector'}
...
```{r ex-NEemJ-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Create a Logical Vector with a Logical Expression'}
...
```{r ex-uzDCk-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset Data Frame Using Logical Vector'}
my_data[yellow, ]
...
```{r ex-s91s1-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset `chicago_air` for Hot Days'}
data(chicago_air)
...
```{r ex-xdO0G-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load `dplyr` and Explore `filter()`'}
...
```{r ex-xGrfr-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Filter `chicago_air` for High Ozone Levels'}
data(chicago_air)
...
```{r ex-4GEoD-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Filter for High Ozone Levels in June'}
data(chicago_air)
...
```{r ex-nZCJu-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Alternative `filter()` Syntax Using `&`'}
data(chicago_air)
high_ozone_june <- filter(chicago_air, ozone > 0.060 & month == 6)
...
```{r ex-dobXr-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` by `ozone`'}
...
```{r ex-oI5Hz-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` in Descending Order by `ozone`'}
data(chicago_air)
...
```{r ex-E6e60-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` by Multiple Columns'}
data(chicago_air)
...
```{r ex-sS6aV-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Count Rows in `chicago_air`'}
...
```{r ex-kZtfG-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Split `chicago_air` into Warm and Cool Subsets'}
data(chicago_air)
...
```{r ex-n1L5E-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Verify Row Counts Before Combining'}
...
```{r ex-ghHy3-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Recombine Data Frames and Verify Row Count'}
data(chicago_air)
