...
```{r ex-Yhx21-1, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install remotes and region5air'}
...
```{r ex-7IcLm-2, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Load `chicago_air` Data Frame'}
library(region5air)
...
```{r ex-xqpeH-3, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install `dplyr` Package'}
...
```{r ex-vWdwc-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'View the First Few Rows of `chicago_air`'}
data(chicago_air)
head(chicago_air)
...
```{r ex-zDpsp-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Specify Number of Lines with `head()`'}
...
```{r ex-9YQVl-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'View the Last Few Rows of `chicago_air`'}
tail(chicago_air)
...
```{r ex-bxPNx-4, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Use `View()` to Inspect `chicago_air`'}
View(chicago_air)
...
```{r ex-cnPk4-5, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Learn More About `chicago_air`'}
?chicago_air
...
```{r ex-PsJsD-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Explore Data Frame Indexing with `my_data`'}
...
```{r ex-pbOkn-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Select a Specific Value Using Indexing'}
my_data[2, 1]
...
```{r ex-fHxaM-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access Another Specific Value Using Indexing'}
my_data[3, 2]
...
```{r ex-Rb1Bh-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Vector Indexing Example'}
x <- c(1, 3, 2, 7, 25.3, 6)
x
...
```{r ex-1ySrG-5, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Vector Element by Index'}
x[5]
...
```{r ex-ZJpoF-6, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset `chicago_air` Data Frame Using Indexing'}
data(chicago_air)
chicago_air[1, ]
...
```{r ex-yjzM5-7, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access Multiple Rows with a Vector of Row Numbers'}
chicago_air[c(1, 2, 5), ]
...
```{r ex-TvRar-8, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Single Column'}
head(chicago_air[, 1])
...
```{r ex-7OV6j-9, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access Multiple Columns'}
...
```{r ex-bAPir-10, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Column by Name'}
...
```{r ex-sCas8-11, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset to Specific Columns by Name'}
...
```{r ex-DF284-12, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Specify Both Rows and Columns for Subsetting'}
...
```{r ex-2JhL4-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Column with `$`'}
data(chicago_air)
...
```{r ex-yEUUV-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Logical Expressions Example 1'}
1 + 1 == 2

```

```{r ex-GDu7D-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Logical Expressions Example 2'}
10 > 20
...
```{r ex-q95ia-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Vector Logical Expression'}
c(25, 80, 55) > 60
...
```{r ex-gLTXM-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Create a Logical Vector for Subsetting'}
my_data <- data.frame(colors = c("red", "green", "yellow"),
                      fruit = c("apple", "grape", "banana"))
...
```{r ex-ufZMf-5, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset Using a Logical Vector'}
...
```{r ex-TwYvE-6, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Create a Logical Vector with a Logical Expression'}
...
```{r ex-i69F7-7, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset Data Frame Using Logical Vector'}
my_data[yellow, ]
...
```{r ex-EFCes-8, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset `chicago_air` for Hot Days'}
...
```{r ex-PW3We-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Load `dplyr` and Explore `filter()`'}
...
```{r ex-oXurg-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Filter `chicago_air` for High Ozone Levels'}
data(chicago_air)
...
```{r ex-9cmoH-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Filter for High Ozone Levels in June'}
data(chicago_air)
...
```{r ex-FVLM3-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Alternative `filter()` Syntax Using `&`'}
data(chicago_air)
high_ozone_june <- filter(chicago_air, ozone > 0.060 & month == 6)
...
```{r ex-dT8ZY-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Sort `chicago_air` by `ozone`'}
...
```{r ex-a4KA5-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Sort `chicago_air` in Descending Order by `ozone`'}
data(chicago_air)
...
```{r ex-J70qO-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Sort `chicago_air` by Multiple Columns'}
data(chicago_air)
...
```{r ex-RqCwK-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Count Rows in `chicago_air`'}
...
```{r ex-hpLKG-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Split `chicago_air` into Warm and Cool Subsets'}
data(chicago_air)
...
```{r ex-yKdi8-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Verify Row Counts Before Combining'}
...
```{r ex-h2mVQ-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Recombine Data Frames and Verify Row Count'}
data(chicago_air)
