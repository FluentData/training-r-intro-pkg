...
```{r ex-kbqJN-1, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install remotes and region5air'}
...
```{r ex-OI6Mf-2, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Load `chicago_air` Data Frame'}
data(chicago_air)
...
```{r ex-8SV1n-3, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install `dplyr` Package'}
...
```{r ex-O4plF-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'View the First Few Rows of `chicago_air`'}
data(chicago_air)
head(chicago_air)
...
```{r ex-Yx71R-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Specify Number of Lines with `head()`'}
...
```{r ex-4PlDa-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'View the Last Few Rows of `chicago_air`'}
tail(chicago_air)
...
```{r ex-GSqk0-4, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Use `View()` to Inspect `chicago_air`'}
View(chicago_air)
...
```{r ex-gp3P7-5, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Learn More About `chicago_air`'}
?chicago_air
...
```{r ex-BpkGD-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Explore Data Frame Indexing with `my_data`'}
...
```{r ex-qzI9W-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Select a Specific Value Using Indexing'}
my_data[2, 1]
...
```{r ex-t2Pvs-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access Another Specific Value Using Indexing'}
my_data[3, 2]
...
```{r ex-yfBVU-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Vector Indexing Example'}
x <- c(1, 3, 2, 7, 25.3, 6)
x
...
```{r ex-SIpIJ-5, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Vector Element by Index'}
x[5]
...
```{r ex-JSlpx-6, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset `chicago_air` Data Frame Using Indexing'}
data(chicago_air)
chicago_air[1, ]
...
```{r ex-fCofe-7, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access Multiple Rows with a Vector of Row Numbers'}
chicago_air[c(1, 2, 5), ]
...
```{r ex-uo0uN-8, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Single Column'}
head(chicago_air[, 1])
...
```{r ex-uHOQ7-9, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access Multiple Columns'}
...
```{r ex-lRoPL-10, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Access a Column by Name'}
...
```{r ex-zsQ7h-11, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Subset to Specific Columns by Name'}
...
```{r ex-Iw6Um-12, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Specify Both Rows and Columns for Subsetting'}
...
```{r ex-ACUjj-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Column with `$`'}
data(chicago_air)
...
```{r ex-0I2Yj-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Logical Expressions Example 1'}
1 + 1 == 2

```

```{r ex-Ge4cz-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Logical Expressions Example 2'}
10 > 20
...
```{r ex-Fxp6H-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Vector Logical Expression'}
c(25, 80, 55) > 60
...
```{r ex-jlNrt-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Create a Logical Vector for Subsetting'}
my_data <- data.frame(colors = c("red", "green", "yellow"),
                      fruit = c("apple", "grape", "banana"))
...
```{r ex-oQ31u-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset Using a Logical Vector'}
...
```{r ex-QYi36-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Create a Logical Vector with a Logical Expression'}
...
```{r ex-DcdoY-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset Data Frame Using Logical Vector'}
my_data[yellow, ]
...
```{r ex-vDCUe-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset `chicago_air` for Hot Days'}
data(chicago_air)
...
```{r ex-lgj04-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load `dplyr` and Explore `filter()`'}
...
```{r ex-4t2jz-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Filter `chicago_air` for High Ozone Levels'}
data(chicago_air)
...
```{r ex-OfG6z-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Filter for High Ozone Levels in June'}
data(chicago_air)
...
```{r ex-g4DNV-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Alternative `filter()` Syntax Using `&`'}
data(chicago_air)
high_ozone_june <- filter(chicago_air, ozone > 0.060 & month == 6)
...
```{r ex-po4R3-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` by `ozone`'}
...
```{r ex-I9DYJ-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` in Descending Order by `ozone`'}
data(chicago_air)
...
```{r ex-e44XY-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` by Multiple Columns'}
data(chicago_air)
...
```{r ex-7qfPE-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Count Rows in `chicago_air`'}
...
```{r ex-eBNAU-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Split `chicago_air` into Warm and Cool Subsets'}
data(chicago_air)
...
```{r ex-dYaIj-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Verify Row Counts Before Combining'}
...
```{r ex-BjJ28-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Recombine Data Frames and Verify Row Count'}
data(chicago_air)
