...
```{r ex-6wiK1-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load `chicago_air` Data Frame'}
data(chicago_air)
...
```{r ex-zhXCH-2, exercise = FALSE, exercise.eval = FALSE, eval = FALSE, exercise.cap = 'Install `dplyr` Package'}
...
```{r ex-KnlRD-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'View the First Few Rows of `chicago_air`'}
data(chicago_air)
head(chicago_air)
...
```{r ex-5LDbm-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Specify Number of Lines with `head()`'}
data(chicago_air)
...
```{r ex-1qAUt-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'View the Last Few Rows of `chicago_air`'}
data(chicago_air)
tail(chicago_air)
...
```{r ex-GCv7f-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Use `View()` to Inspect `chicago_air`'}
data(chicago_air)
View(chicago_air)
...
```{r ex-JDWqG-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Learn More About `chicago_air`'}
?chicago_air
...
```{r ex-Vhe21-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Explore Data Frame Indexing with `my_data`'}
...
```{r ex-c26CI-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Select a Specific Value Using Indexing'}
my_data[2, 1]
...
```{r ex-bdSdp-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access Another Specific Value Using Indexing'}
my_data[3, 2]
...
```{r ex-54xbn-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Vector Indexing Example'}
x <- c(1, 3, 2, 7, 25.3, 6)
x
...
```{r ex-lzp3w-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Vector Element by Index'}
x[5]
...
```{r ex-dvaSW-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset `chicago_air` Data Frame Using Indexing'}
data(chicago_air)
chicago_air[1, ]
...
```{r ex-m0BhJ-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access Multiple Rows with a Vector of Row Numbers'}
data(chicago_air)
chicago_air[c(1, 2, 5), ]
...
```{r ex-g7A32-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Single Column'}
data(chicago_air)
head(chicago_air[, 1])
...
```{r ex-fMpFj-9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access Multiple Columns'}
data(chicago_air)
...
```{r ex-kzV6j-10, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Column by Name'}
data(chicago_air)
...
```{r ex-oGEmr-11, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset to Specific Columns by Name'}
data(chicago_air)
...
```{r ex-XFSJ4-12, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Specify Both Rows and Columns for Subsetting'}
...
```{r ex-6xvxH-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Access a Column with `$`'}
data(chicago_air)
...
```{r ex-5wAI4-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Logical Expressions Example 1'}
1 + 1 == 2

```

```{r ex-ejfud-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Logical Expressions Example 2'}
10 > 20
...
```{r ex-DlaPL-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Vector Logical Expression'}
c(25, 80, 55) > 60
...
```{r ex-21WYI-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Create a Logical Vector for Subsetting'}
my_data <- data.frame(colors = c("red", "green", "yellow"),
                      fruit = c("apple", "grape", "banana"))
...
```{r ex-sEk2e-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset Using a Logical Vector'}
...
```{r ex-MnvL1-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Create a Logical Vector with a Logical Expression'}
...
```{r ex-a5y6T-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset Data Frame Using Logical Vector'}
my_data[yellow, ]
...
```{r ex-2uYLb-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Subset `chicago_air` for Hot Days'}
data(chicago_air)
...
```{r ex-lbWOB-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load `dplyr` and Explore `filter()`'}
...
```{r ex-5JvvD-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Filter `chicago_air` for High Ozone Levels'}
data(chicago_air)
...
```{r ex-ZTpqB-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Filter for High Ozone Levels in June'}
data(chicago_air)
...
```{r ex-4F3Dj-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Alternative `filter()` Syntax Using `&`'}
data(chicago_air)
high_ozone_june <- filter(chicago_air, ozone > 0.060 & month == 6)
...
```{r ex-gBIfC-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` by `ozone`'}
...
```{r ex-BHhgd-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` in Descending Order by `ozone`'}
data(chicago_air)
...
```{r ex-S7YuE-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Sort `chicago_air` by Multiple Columns'}
data(chicago_air)
...
```{r ex-iN7cR-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Count Rows in `chicago_air`'}
...
```{r ex-bFcau-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Split `chicago_air` into Warm and Cool Subsets'}
data(chicago_air)
...
```{r ex-C466c-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Verify Row Counts Before Combining'}
...
```{r ex-ZxDYZ-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Recombine Data Frames and Verify Row Count'}
data(chicago_air)
