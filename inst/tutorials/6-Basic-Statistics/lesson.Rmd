...
```{r ex-AnFJW-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Extract example data'}
data("chicago_air")
...
```{r ex-WGHsV-2, exercise = FALSE, eval = TRUE, exercise.cap = 'Find minimum value'}
min(ozone, na.rm=TRUE)

```

```{r ex-3yKIv-3, exercise = FALSE, eval = TRUE, exercise.cap = 'Find maximum value'}
max(ozone, na.rm=TRUE)

```

```{r ex-07Yrf-4, exercise = FALSE, eval = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-4QOpc-5, exercise = FALSE, eval = TRUE, exercise.cap = 'Summary statistics'}
summary(ozone)
...
```{r ex-73dv4-6, exercise = FALSE, eval = TRUE, exercise.cap = 'Calculate IQR'}
...
```{r ex-48Jvj-7, exercise = FALSE, eval = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(ozone)
...
```{r ex-mUlYd-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Calculate mean'}
mean(ozone, na.rm=TRUE)

```

```{r ex-LSIFi-2, exercise = FALSE, eval = TRUE, exercise.cap = 'Calculate median'}
...
```{r ex-lLzSa-3, exercise = FALSE, eval = TRUE, exercise.cap = 'Calculate variance'}
var(ozone, na.rm=TRUE)

```

```{r ex-5ASYN-4, exercise = FALSE, eval = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(ozone, na.rm=TRUE)
...
```{r ex-i57cn-1, warning = FALSE, message = FALSE, exercise = FALSE, eval = TRUE, exercise.cap = 'Visualize dataset'}
library(ggplot2)
...
```{r ex-ewC1Y-2, warning = FALSE, message = FALSE, exercise = FALSE, eval = TRUE, exercise.cap = 'Compare two groups'}
library(dplyr)
...
```{r ex-3cHu5-3, exercise = FALSE, eval = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-JwRUN-4, exercise = FALSE, eval = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-kkKgQ-5, exercise = FALSE, eval = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-Eojx7-6, exercise = FALSE, eval = TRUE, exercise.cap = 'Students t test between two groups'}
...
```{r ex-NTUHJ-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Correlation matrix of select variables'}
data(chicago_air)
...
```{r ex-2IlUi-2, exercise = FALSE, eval = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-pvfoz-3, exercise = FALSE, eval = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-2vvUx-4, exercise = FALSE, eval = TRUE, exercise.cap = 'Pairwise plots of select variables'}
