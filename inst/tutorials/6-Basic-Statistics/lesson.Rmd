...
```{r ex-mDjei-1, exercise = TRUE, exercise.cap = 'Extract example data'}
...
```{r ex-O3Ass-2, exercise = TRUE, exercise.cap = 'Find minimum value'}
min(data, na.rm=TRUE)

```

```{r ex-19cGC-3, exercise = TRUE, exercise.cap = 'Find maximum value'}
max(data, na.rm=TRUE)

```

```{r ex-tx343-4, exercise = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-R8OKn-5, exercise = TRUE, exercise.cap = 'Summary statistics'}
summary(data)
...
```{r ex-tRmi4-6, exercise = TRUE, exercise.cap = 'Calculate IQR'}
IQR(data, na.rm=TRUE)
...
```{r ex-QmJoh-7, exercise = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(data)
...
```{r ex-GT6qd-1, exercise = TRUE, exercise.cap = 'Calculate mean'}
mean(data, na.rm=TRUE)

```

```{r ex-HKOuN-2, exercise = TRUE, exercise.cap = 'Calculate median'}
...
```{r ex-RjYGl-3, exercise = TRUE, exercise.cap = 'Calculate variance'}
var(data, na.rm=TRUE)

```

```{r ex-LmY7H-4, exercise = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(data, na.rm=TRUE)
...
```{r ex-ZG8No-1, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Visualize dataset'}
...
```{r ex-Ok1Il-2, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Compare two groups'}
...
```{r ex-Il2v8-3, exercise = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-ify6Z-4, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-UHZGF-5, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-29Rah-6, exercise = TRUE, exercise.cap = 'Student's t-test between two groups'}
...
```{r ex-AnIql-1, exercise = TRUE, exercise.cap = 'Correlation matrix of select variables'}
...
```{r ex-E5Mem-2, exercise = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-uy8vN-3, exercise = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-w5c7c-4, exercise = TRUE, exercise.cap = 'Pairwise plots of select variables'}
