...
```{r ex-OvzXh-2, exercise = TRUE, exercise.cap = 'Find minimum value'}
min(data, na.rm=TRUE)

```

```{r ex-S5tF6-3, exercise = TRUE, exercise.cap = 'Find maximum value'}
max(data, na.rm=TRUE)

```

```{r ex-fZq9J-4, exercise = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-WlGqt-5, exercise = TRUE, exercise.cap = 'Summary statistics'}
summary(data)
...
```{r ex-MrRFk-6, exercise = TRUE, exercise.cap = 'Calculate IQR'}
IQR(data, na.rm=TRUE)
...
```{r ex-Zl2MW-7, exercise = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(data)
...
```{r ex-xtlnV-1, exercise = TRUE, exercise.cap = 'Calculate mean'}
...
```{r ex-Gymng-3, exercise = TRUE, exercise.cap = 'Calculate variance'}
var(data, na.rm=TRUE)

```

```{r ex-ywSV1-4, exercise = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(data, na.rm=TRUE)
...
```{r ex-IZZoZ-1, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Visualize dataset'}
...
```{r ex-jRYZK-2, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Compare two groups'}
...
```{r ex-Newy0-3, exercise = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-FAgan-4, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-4JfUa-5, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-4ZJf3-6, exercise = TRUE, exercise.cap = 'Student's t-test between two groups'}
...
```{r ex-RvBN0-1, exercise = TRUE, exercise.cap = 'Correlation matrix of select variables'}
...
```{r ex-33Nto-2, exercise = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-uUpmT-3, exercise = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-lt9er-4, exercise = TRUE, exercise.cap = 'Pairwise plots of select variables'}
