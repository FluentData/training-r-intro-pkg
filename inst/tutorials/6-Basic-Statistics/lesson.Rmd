...
```{r ex-T9qrI-1, exercise = TRUE, exercise.cap = 'Extract example data'}
...
```{r ex-2BGPc-2, exercise = TRUE, exercise.cap = 'Find minimum value'}
min(data, na.rm=TRUE)

```

```{r ex-npk2E-3, exercise = TRUE, exercise.cap = 'Find maximum value'}
max(data, na.rm=TRUE)

```

```{r ex-vTy5E-4, exercise = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-15Hz5-5, exercise = TRUE, exercise.cap = 'Summary statistics'}
summary(data)
...
```{r ex-Ef4yk-6, exercise = TRUE, exercise.cap = 'Calculate IQR'}
IQR(data, na.rm=TRUE)
...
```{r ex-bZFVd-7, exercise = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(data)
...
```{r ex-T2v9H-1, exercise = TRUE, exercise.cap = 'Calculate mean'}
mean(data, na.rm=TRUE)

```

```{r ex-KR2h2-2, exercise = TRUE, exercise.cap = 'Calculate median'}
...
```{r ex-ufHCE-3, exercise = TRUE, exercise.cap = 'Calculate variance'}
var(data, na.rm=TRUE)

```

```{r ex-tw3FQ-4, exercise = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(data, na.rm=TRUE)
...
```{r ex-IZTcb-1, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Visualize dataset'}
...
```{r ex-Maqk9-2, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Compare two groups'}
...
```{r ex-v1Wnc-3, exercise = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-MP5Et-4, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-w8mKM-5, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-fkV79-6, exercise = TRUE, exercise.cap = 'Student's t-test between two groups'}
...
```{r ex-iSI7h-1, exercise = TRUE, exercise.cap = 'Correlation matrix of select variables'}
...
```{r ex-Ptv4n-2, exercise = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-F5OX2-3, exercise = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-LR4Kt-4, exercise = TRUE, exercise.cap = 'Pairwise plots of select variables'}
