...
```{r ex-weaEx-2, exercise = TRUE, exercise.cap = 'Find minimum value'}
min(data, na.rm=TRUE)

```

```{r ex-7QIRr-3, exercise = TRUE, exercise.cap = 'Find maximum value'}
max(data, na.rm=TRUE)

```

```{r ex-xgBvB-4, exercise = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-UT6Xm-5, exercise = TRUE, exercise.cap = 'Summary statistics'}
summary(data)
...
```{r ex-eXOtH-6, exercise = TRUE, exercise.cap = 'Calculate IQR'}
IQR(data, na.rm=TRUE)
...
```{r ex-Iw1o0-7, exercise = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(data)
...
```{r ex-K7PqR-1, exercise = TRUE, exercise.cap = 'Calculate mean'}
mean(data, na.rm=TRUE)

```

```{r ex-bkBnL-2, exercise = TRUE, exercise.cap = 'Calculate median'}
...
```{r ex-kPlk7-3, exercise = TRUE, exercise.cap = 'Calculate variance'}
var(data, na.rm=TRUE)

```

```{r ex-kmE21-4, exercise = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(data, na.rm=TRUE)
...
```{r ex-qqNT1-1, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Visualize dataset'}
...
```{r ex-RSizC-2, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Compare two groups'}
...
```{r ex-5Ltn0-3, exercise = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-rKJeL-4, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-gKeKN-5, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-5CJ5g-6, exercise = TRUE, exercise.cap = 'Student's t-test between two groups'}
...
```{r ex-Mt13i-1, exercise = TRUE, exercise.cap = 'Correlation matrix of select variables'}
...
```{r ex-cBslA-2, exercise = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-hmGTn-3, exercise = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-3N14X-4, exercise = TRUE, exercise.cap = 'Pairwise plots of select variables'}
