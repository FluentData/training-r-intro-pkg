...
```{r ex-vb3PY-2, exercise = TRUE, exercise.cap = 'Find minimum value'}
min(data, na.rm=TRUE)

```

```{r ex-awwNz-3, exercise = TRUE, exercise.cap = 'Find maximum value'}
max(data, na.rm=TRUE)

```

```{r ex-UcPGQ-4, exercise = TRUE, exercise.cap = 'Find range of values'}
...
```{r ex-TTxJF-5, exercise = TRUE, exercise.cap = 'Summary statistics'}
summary(data)
...
```{r ex-0Uz5N-6, exercise = TRUE, exercise.cap = 'Calculate IQR'}
IQR(data, na.rm=TRUE)
...
```{r ex-9ZmCe-7, exercise = TRUE, exercise.cap = 'Visualize IQR with boxplot'}
boxplot(data)
...
```{r ex-lewxj-1, exercise = TRUE, exercise.cap = 'Calculate mean'}
...
```{r ex-2LPqj-3, exercise = TRUE, exercise.cap = 'Calculate variance'}
var(data, na.rm=TRUE)

```

```{r ex-os2Ij-4, exercise = TRUE, exercise.cap = 'Calculate standard deviation'}
sd(data, na.rm=TRUE)
...
```{r ex-dXnAG-1, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Visualize dataset'}
...
```{r ex-0aPfw-2, warning = FALSE, message = FALSE, exercise = TRUE, exercise.cap = 'Compare two groups'}
...
```{r ex-cNlFU-3, exercise = TRUE, exercise.cap = 'Check for normality with histograms'}
...
```{r ex-VcWO3-4, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group1'}
...
```{r ex-A0jwf-5, exercise = TRUE, exercise.cap = 'Shapiro-Wilk test for Group2'}
...
```{r ex-8g4Rk-6, exercise = TRUE, exercise.cap = 'Student's t-test between two groups'}
...
```{r ex-asNU8-1, exercise = TRUE, exercise.cap = 'Correlation matrix of select variables'}
...
```{r ex-dCgBz-2, exercise = TRUE, exercise.cap = 'Test correlation between two variables'}
...
```{r ex-g79Ns-3, exercise = TRUE, exercise.cap = 'Test correlation between another set of two variables'}
...
```{r ex-semLW-4, exercise = TRUE, exercise.cap = 'Pairwise plots of select variables'}
