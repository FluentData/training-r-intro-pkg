...
```{r ex-NQKSW-1, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Load Example Data Frame'}
...
```{r ex-A4ceZ-1, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Inspect Example Dataset Data Types'}
str(example_dataset)
...
```{r ex-SquPk-2, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Check Data Types'}
...
```{r ex-g2J9r-1, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Identify and Correct Unallowed Data'}
...
```{r ex-SVhhL-1, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Identify and Handle Outliers'}
...
```{r ex-z4Cv1-2, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Return Outlier Values from Boxplot'}
...
```{r ex-v8p41-1, eval = TRUE, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Examples of Common Syntax Mistakes'}
