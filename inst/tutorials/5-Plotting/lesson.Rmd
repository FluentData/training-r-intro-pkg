...
```{r ex-WmpIN-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading Data'}
data(chicago_air)
...
```{r ex-mprS0-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Basic Plot'}
...
```{r ex-6RNew-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Scatter Plot'}
...
```{r ex-UjZBQ-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Graph'}
...
```{r ex-qXCFF-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Plot'}
...
```{r ex-HxDBk-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Default Histogram'}
...
```{r ex-pn82v-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Histogram'}
hist(chicago_air$ozone,
     breaks = 20,
...
```{r ex-DqR5T-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Box Plot'}
...
```{r ex-MfDZd-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading ggplot2 Package'}
library(ggplot2)
...
```{r ex-QA75M-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Scatter Plot'}
...
```{r ex-4ylyu-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized ggplot Scatter Plot'}
ggplot(chicago_air, aes(x = temp, y = ozone)) +
...
```{r ex-yBykX-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Color Coded Scatter Plot'}
...
```{r ex-G0l0I-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Plot Over Time'}
...
```{r ex-WzjC4-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Histogram'}
...
```{r ex-XFlIb-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple ggplot Box Plot'}
...
```{r ex-bnjIN-9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Grouped Box Plot'}
...
```{r ex-fvlLl-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Faceted Histogram'}
ggplot(chicago_air, aes(ozone)) +
  geom_histogram() +
  facet_wrap("month")
