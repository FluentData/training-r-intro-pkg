...
```{r ex-gB1KA-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading Data'}
data(chicago_air)
...
```{r ex-A2RBs-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Basic Plot'}
...
```{r ex-rgEB7-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Scatter Plot'}
...
```{r ex-KSvM5-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Converting Date Column'}
...
```{r ex-d6zoh-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Graph'}
...
```{r ex-aVnUD-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Plot'}
...
```{r ex-6siGd-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Default Histogram'}
...
```{r ex-pRpic-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Histogram'}
hist(chicago_air$ozone,
     breaks = 20,
...
```{r ex-e9R4i-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Box Plot'}
...
```{r ex-B2wt0-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Box Plot by Month'}
...
```{r ex-rxsKI-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading ggplot2 Package'}
library(ggplot2)
...
```{r ex-UCuu5-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Base ggplot'}
...
```{r ex-sUCGG-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Scatter Plot'}
...
```{r ex-RN8sI-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized ggplot Scatter Plot'}
ggplot(chicago_air, aes(x = temp, y = ozone)) +
...
```{r ex-IJnw2-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Color Coded Scatter Plot'}
...
```{r ex-zoGks-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Plot Over Time'}
...
```{r ex-6VLkg-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Histogram'}
...
```{r ex-f3W71-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple ggplot Box Plot'}
...
```{r ex-M0JuT-9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Grouped Box Plot'}
...
```{r ex-MoOh5-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Faceted Histogram'}
ggplot(chicago_air, aes(ozone)) +
  geom_histogram() +
  facet_wrap("month")
...
```{r ex-uHhcH-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Linear Model Fitted Line', message = FALSE, warning = FALSE}
...
```{r ex-AksR0-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Nonlinear Curve Fitting', message = FALSE, warning = FALSE}
ggplot(chicago_air, aes(temp, ozone) ) +
  geom_point() +
