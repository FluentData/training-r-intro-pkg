...
```{r ex-pFXUx-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading Data'}
data(chicago_air)
...
```{r ex-j7Lsc-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Basic Plot'}
...
```{r ex-0nmTj-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Scatter Plot'}
...
```{r ex-w69D7-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Graph'}
...
```{r ex-rNSVR-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Plot'}
...
```{r ex-4smPc-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Default Histogram'}
...
```{r ex-GwTQO-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized Histogram'}
hist(chicago_air$ozone,
     breaks = 20,
...
```{r ex-6K6PA-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple Box Plot'}
...
```{r ex-zvHLa-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Loading ggplot2 Package'}
library(ggplot2)
...
```{r ex-KpaPR-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Base ggplot'}
...
```{r ex-gwuQx-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Scatter Plot'}
...
```{r ex-HZpOi-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Customized ggplot Scatter Plot'}
ggplot(chicago_air, aes(x = temp, y = ozone)) +
...
```{r ex-XFCra-5, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Color Coded Scatter Plot'}
...
```{r ex-4IAKH-6, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Line Plot Over Time'}
...
```{r ex-gcloO-7, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'ggplot Histogram'}
...
```{r ex-5ytTS-8, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Simple ggplot Box Plot'}
...
```{r ex-OWMkH-9, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Grouped Box Plot'}
...
```{r ex-bj7Iz-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Faceted Histogram'}
ggplot(chicago_air, aes(ozone)) +
  geom_histogram() +
  facet_wrap("month")
