...
```{r ex-7nqo2-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Practice Basic Math Operations'}
10 + 5
10 - 5
10 * 5
10 / 5
...
```{r ex-BRp7h-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Understanding Order of Operations'}
10 - 3 / 5

```

```{r ex-NM5I0-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Practicing Grouping with Parentheses'}
(10 - 3) / 5
...
```{r ex-LcAdb-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Experiment with Comments'}
# Full line comment
...
```{r ex-uuwEP-2, exercise = FALSE, eval = TRUE, exercise.cap = 'Code and Output Example'}
1+1
...
```{r ex-94DBv-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Variables'}
x <- 10
y <- 5
x + y
...
```{r ex-GuvHA-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Exploring Variable Assignment'}
x

```

```{r ex-7Ltup-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Updating Variable Values'}
x <- 20
x
...
```{r ex-aAUUH-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Variable Naming Rules'}
y <- 5
Y <- 10
...
```{r ex-19FJx-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Numeric Vectors'}
x <- c(1, 2, 3, 4, 5)
x

```

```{r ex-PBtWI-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Character Vectors'}
...
```{r ex-7nZoG-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Error Without Quotes'}
fruit <- c(apples, bananas, oranges)
...
```{r ex-5Fhv4-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Accessing Vector Elements'}
fruit[3]
...
```{r ex-6n4iC-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Lists'}
...
```{r ex-RpG4A-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Accessing List Elements'}
x[[2]]
...
```{r ex-LzgX9-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Lists Containing Vectors and Lists'}
my_vector <- c(1, 2, 3)
...
```{r ex-7l5rU-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Data Frames'}
...
```{r ex-5KjLa-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data Frame Dimension Mismatch Error'}
