...
```{r ex-YemNw-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Practice Basic Math Operations'}
10 + 5
10 - 5
10 * 5
10 / 5
...
```{r ex-mEbFR-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Understanding Order of Operations'}
10 - 3 / 5

```

```{r ex-jjhc1-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Practicing Grouping with Parentheses'}
(10 - 3) / 5
...
```{r ex-UEFzw-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Experiment with Comments'}
# Full line comment
...
```{r ex-TnI6o-2, exercise = FALSE, eval = TRUE, exercise.cap = 'Code and Output Example'}
1+1
...
```{r ex-NjzpC-3, exercise = FALSE, eval = FALSE, echo = TRUE, exercise.cap = 'Console Code Execution'}
> 1 + 1
[1] 2
...
```{r ex-ZPwSO-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Variables'}
x <- 10
y <- 5
x + y
...
```{r ex-8tJnD-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Exploring Variable Assignment'}
x

```

```{r ex-grxML-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Updating Variable Values'}
x <- 20
x
...
```{r ex-8K6K0-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Variable Naming Rules'}
y <- 5
Y <- 10
...
```{r ex-Prz20-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Numeric Vectors'}
x <- c(1, 2, 3, 4, 5)
x

```

```{r ex-yBmzf-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Character Vectors'}
...
```{r ex-83ydL-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Error Without Quotes'}
fruit <- c(apples, bananas, oranges)
...
```{r ex-8dtjh-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Accessing Vector Elements'}
fruit[3]
...
```{r ex-ljmUO-1, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Creating Lists'}
...
```{r ex-rjZ8I-2, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Accessing List Elements'}
x[[2]]
...
```{r ex-NhPDN-3, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Lists Containing Vectors and Lists'}
my_vector <- c(1, 2, 3)
...
```{r ex-XHeMG-4, exercise = FALSE, exercise.eval = TRUE, exercise.cap = 'Nested List Access'}
y[[3]][[2]]
...
```{r ex-ZV8Vu-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Data Frames'}
...
```{r ex-hHITP-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data Frame Dimension Mismatch Error'}
