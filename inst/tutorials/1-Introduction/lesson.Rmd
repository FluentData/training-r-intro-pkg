...
```{r ex-gspio-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Practice Basic Math Operations'}
10 + 5
10 - 5
10 * 5
10 / 5
...
```{r ex-LkNe4-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Understanding Order of Operations'}
10 - 3 / 5

```

```{r ex-7QN0K-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Practicing Grouping with Parentheses'}
(10 - 3) / 5
...
```{r ex-N32ao-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Experiment with Comments'}
# Full line comment
...
```{r ex-pot7N-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Code and Output Example'}
1+1
...
```{r ex-fensd-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Console Code Execution'}
1 + 1
...
```{r ex-V9kEg-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Variables'}
x <- 10
y <- 5
x + y
...
```{r ex-G9E1a-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Exploring Variable Assignment'}
x

```

```{r ex-cr3rg-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Updating Variable Values'}
x <- 20
x
...
```{r ex-2mgf1-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Variable Naming Rules'}
x <- 5
X <- 5
...
```{r ex-ZfVqE-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Numeric Vectors'}
x <- c(1, 2, 3, 4, 5)
x

```

```{r ex-HzYA5-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Character Vectors'}
...
```{r ex-gNcFG-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Error Without Quotes'}
fruit <- c(apples, bananas, oranges)
...
```{r ex-wLVHd-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Accessing Vector Elements'}
fruit[3]
...
```{r ex-g7gro-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Lists'}
...
```{r ex-nOMMc-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Accessing List Elements'}
x[[2]]
...
```{r ex-g5Yed-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Lists Containing Vectors and Lists'}
my_vector <- c(1, 2, 3)
...
```{r ex-E83T7-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Nested List Access'}
y[[3]][[2]]
...
```{r ex-y4an5-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Data Frames'}
...
```{r ex-u7NB0-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data Frame Dimension Mismatch Error'}
