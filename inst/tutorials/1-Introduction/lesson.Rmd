...
```{r ex-bPZt0-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Practice Basic Math Operations'}
10 + 5
10 - 5
10 * 5
10 / 5
...
```{r ex-ykH12-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Understanding Order of Operations'}
10 - 3 / 5

```

```{r ex-qeOCv-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Practicing Grouping with Parentheses'}
(10 - 3) / 5
...
```{r ex-6edAy-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Experiment with Comments'}
# Full line comment
...
```{r ex-WwgSA-2, exercise = FALSE, eval = TRUE, exercise.cap = 'Code and Output Example'}
1+1
...
```{r ex-mMpFn-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Variables'}
x <- 10
y <- 5
x + y
...
```{r ex-4Aher-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Exploring Variable Assignment'}
x

```

```{r ex-6FMuV-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Updating Variable Values'}
x <- 20
x
...
```{r ex-rbQdo-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Variable Naming Rules'}
y <- 5
Y <- 10
...
```{r ex-ASwYE-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Numeric Vectors'}
x <- c(1, 2, 3, 4, 5)
x

```

```{r ex-qXb3N-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Character Vectors'}
...
```{r ex-2si1E-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Error Without Quotes'}
fruit <- c(apples, bananas, oranges)
...
```{r ex-icerQ-4, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Accessing Vector Elements'}
fruit[3]
...
```{r ex-X8z2D-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Lists'}
...
```{r ex-EX1dw-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Accessing List Elements'}
x[[2]]
...
```{r ex-UJ7Pe-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Lists Containing Vectors and Lists'}
my_vector <- c(1, 2, 3)
...
```{r ex-hhNQ3-1, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Creating Data Frames'}
...
```{r ex-GHIDP-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data Frame Dimension Mismatch Error'}
