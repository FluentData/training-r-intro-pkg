...
```{r ex-KHDEJ-1, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Load Example Data Frame'}
...
```{r ex-KoqSs-1, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Inspect Example Dataset Data Types'}
str(example_dataset)
...
```{r ex-icxBW-2, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Check Data Types'}
...
```{r ex-aXeXk-3, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Correcting Data Types with colClasses'}
...
```{r ex-nJPWc-1, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Identify and Correct Unallowed Data'}
...
```{r ex-9JuyA-1, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Identify and Handle Outliers'}
...
```{r ex-MkSCG-1, eval = TRUE, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Examples of Common Syntax Mistakes'}
