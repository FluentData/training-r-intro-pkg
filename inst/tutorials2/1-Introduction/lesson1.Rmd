...
```{r ex-Efjti-1, exercise = FALSE, eval = TRUE, exercise.cap = 'Practice Basic Math Operations'}
10 + 5
10 - 5
10 * 5
10 / 5
...
```{r ex-cMG42-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Understanding Order of Operations'}
10 - 3 / 5

```

```{r ex-hWQST-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Practicing Grouping with Parentheses'}
(10 - 3) / 5
...
```{r ex-t5wZf-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Experiment with Comments'}
# Full line comment
...
```{r ex-4PgGC-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Code and Output Example'}
1+1
...
```{r ex-ci58y-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Console Code Execution'}
1 + 1
...
```{r ex-npAko-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Creating Variables'}
x <- 10
y <- 5
x + y
...
```{r ex-VSeBn-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Exploring Variable Assignment'}
x

```

```{r ex-YXk7C-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Updating Variable Values'}
x <- 20
x
...
```{r ex-jUXCU-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Variable Naming Rules'}
x <- 5
X <- 5
...
```{r ex-qiuZu-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Creating Numeric Vectors'}
x <- c(1, 2, 3, 4, 5)
x

```

```{r ex-QT2LJ-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Creating Character Vectors'}
...
```{r ex-LMEdv-3, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Error Without Quotes'}
fruit <- c(apples, bananas, oranges)
...
```{r ex-GFeDe-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Accessing Vector Elements'}
fruit[3]
...
```{r ex-xygWO-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Creating Lists'}
...
```{r ex-mXGsN-2, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Accessing List Elements'}
x[[2]]
...
```{r ex-dSmXi-3, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Lists Containing Vectors and Lists'}
my_vector <- c(1, 2, 3)
...
```{r ex-HD0jm-4, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Nested List Access'}
y[[3]][[2]]
...
```{r ex-Nq9IJ-1, exercise = TRUE, exercise.eval = TRUE, exercise.cap = 'Creating Data Frames'}
...
```{r ex-v4Ndj-2, exercise = TRUE, exercise.eval = FALSE, exercise.cap = 'Data Frame Dimension Mismatch Error'}
